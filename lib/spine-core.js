...
(function (spine) {
    var UnityAtlas = (function () {
        ...
        UnityAtlas.load = function (loader, json_path, texture_path, success, error) {
            ...
            loader.loadText(json_path, function (path, atlasData) {
                loader.loadTexture(texture_path, function (imagePath, image) {
    ...
    var UnityAtlasItem = (function () {
        ...
        UnityAtlasItem.prototype.getMesh = function (_width, _height, _start_x, _start_y, _scale_x, _scale_y, _flip_x, _flip_y) {
